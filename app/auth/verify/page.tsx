...
function VerifyForm() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 flex flex-col px-6 pt-14">
      <div className="max-w-sm w-full mx-auto">
        <Link href="/signup" className="inline-flex items-center text-gray-500 dark:text-slate-400 mb-10 -ml-1">
        ...
        <p className="text-gray-500 dark:text-slate-400 mb-0.5">Enter the 6-digit code sent to</p>
          ...
          {digits.map((digit, i) => (
            <input
              ...
              className={`w-full aspect-square text-center text-xl font-bold rounded-2xl outline-none transition-colors border-2 ${
                i === activeIndex
                  ? 'border-[#1d67ba] bg-white dark:bg-slate-900 text-gray-900 dark:text-white'
                  : digit
                  ? 'border-[#1d67ba] bg-white dark:bg-slate-900 text-gray-900 dark:text-white'
                  : 'border-transparent bg-gray-100 dark:bg-slate-800 text-gray-900 dark:text-white'
              }`}
            />
          ))}
        </div>
