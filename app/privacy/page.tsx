      ...
      <div className="bg-[#F4F2EC]">
        <div className="mx-auto max-w-[1440px] px-6 pb-20 lg:px-12">
          <div className="max-w-2xl">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#191917]">Information we collect</h2>
            <p className="text-sm leading-relaxed text-[#5F5D54]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#191917]">How we use it</h2>
            <p className="text-sm leading-relaxed text-[#5F5D54]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#191917]">Payment processing</h2>
            <p className="text-sm leading-relaxed text-[#5F5D54]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#191917]">Data sharing</h2>
            <p className="text-sm leading-relaxed text-[#5F5D54]">
            ...
            <h2 className="mb-3 mt-10 text-xl font-semibold text-[#191917]">Your rights</h2>
            <p className="text-sm leading-relaxed text-[#5F5D54]">
