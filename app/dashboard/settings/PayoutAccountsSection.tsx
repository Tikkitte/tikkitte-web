    ...
    <section className="create-card border-[1.5px] border-[#bcd2f7] p-6">
      ...
      {primary ? (
        <div className="space-y-4">
          ...
          {primary.branch && <div><p className="mb-1.5 text-sm font-medium">Branch</p><div className="create-input bg-[#faf9f5]">{primary.branch}</div></div>}
