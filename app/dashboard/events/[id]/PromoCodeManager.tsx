  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
      <div className="flex items-center justify-between gap-4 mb-4">
        <div>
          <h2 className="font-semibold text-gray-900 text-sm">Promo codes</h2>
          <p className="text-xs text-gray-400 mt-1">Create discounts attendees can apply at checkout.</p>
        </div>
        <button
          type="button"
