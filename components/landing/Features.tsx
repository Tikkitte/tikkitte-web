  ...
  return (
    <section className="mx-auto max-w-[1280px] px-5 pt-[clamp(80px,12vh,130px)] lg:px-14">
      <div className="text-center">
        ...
        <h2 className="mx-auto mt-4 max-w-[800px] font-anton font-normal text-[clamp(34px,5vw,64px)] uppercase leading-[1.02] text-[#191917]">
          Everything you need to run the door
        </h2>
      </div>
      <div className="mt-[52px] grid grid-cols-1 gap-[18px] min-[760px]:grid-cols-3">
        {features.map((f) => (
          <div key={f.num} className="rounded-[20px] border border-[#E4DFD1] bg-white p-7">
            <div className="font-anton font-normal text-[15px] tracking-[0.1em] text-[#2565D0]">{f.num}</div>
            <h3 className="mt-3 font-anton font-normal text-[23px] uppercase text-[#191917]">{f.title}</h3>
