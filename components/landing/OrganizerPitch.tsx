...
export default function OrganizerPitch() {
  return (
    <section className="mx-auto max-w-[1280px] px-5 pt-[clamp(72px,10vh,120px)] lg:px-14">
      <div className="grid grid-cols-1 items-center gap-10 rounded-[28px] bg-[#2565D0] p-[clamp(32px,5vw,64px)] [grid-template-columns:repeat(auto-fit,minmax(300px,1fr))]">
        <div>
          <div className="text-[13px] font-bold uppercase tracking-[0.16em] text-[#BCD2F7]">For organizers</div>
          <h2 className="mt-4 font-anton text-[clamp(34px,4.5vw,58px)] uppercase leading-[1.02] text-white">
