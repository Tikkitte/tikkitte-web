  ...
  return (
    <section id="how-it-works" className="mx-auto max-w-[1280px] px-5 pt-[clamp(80px,12vh,130px)] lg:px-14">
      <div className="rounded-[28px] bg-[#2565D0] p-[clamp(36px,5vw,64px)]">
        ...
        <h2 className="mt-3.5 font-anton text-[clamp(32px,4.5vw,56px)] uppercase leading-[1.02] text-white">Live in three steps</h2>

        <div className="mt-10 grid grid-cols-1 gap-5 [grid-template-columns:repeat(auto-fit,minmax(240px,1fr))]">
          {steps.map((step) => (
            <div key={step.number} className="rounded-[18px] bg-white/10 p-[26px]">
              <div className="font-anton text-[34px] text-white">{step.number}</div>
              <h3 className="mt-3 font-anton text-xl uppercase text-white">{step.title}</h3>
